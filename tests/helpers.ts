...
import { DrizzleSessionTrackingRepository, DrizzleSessionRepository } from "../src/repositories/session-repository.js";
import { MockEmbeddingProvider } from "../src/providers/embedding/mock.js";
import { MemoryService } from "../src/services/memory-service.js";
import { memories, projects, comments, sessionTracking, sessions } from "../src/db/schema.js";
...
export function createTestServiceWithSessions(): MemoryService {
  ...
  return new MemoryService(memoryRepo, projectRepo, embedder, commentRepo, sessionTrackingRepo, sessionLifecycleRepo);
}
